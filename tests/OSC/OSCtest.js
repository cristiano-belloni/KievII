var OSCTest = {
    ...
    init: function () {
        ...
        this.handler = new OSCHandler (this.proxyServer, this.udpHosts);
        ...
        var clickBarArgs = {
            ...
            onValueSet: function (slot, value, element) {
                var msg = new Message('/curve/set/', parseInt(element['testClickBar'.length], 10), value);
            ...
            onValueSet: function (slot, value, element) {
                if (slot === 'points') {
                    for (var i = 0; i < value.length; i+=1) {
                        ...
                        var msg = new Message('/click/set/', i, clValue);
